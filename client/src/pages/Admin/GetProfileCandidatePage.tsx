...
const GetCandidatePage = ({ setEditCandidate, id }: any) => {
  ...
  const idCan = useAppSelector((state) => state.auth.id);
  ...
  useEffect(() => {
    if (accessToken) {
      dispatch(getOneCandidate({ id: idCan, accessToken }));
    }
    ...
    <div className="dataEntry">
      ...
      >
        {!editCandidate ? (
                  ...
                  <div className="d-flex justify-content-between">
                    <div className="p-2">
                      ...
                      <button
                        ...
                        onClick={() => {
                          dispatch(deleteCandidate({ id: idCan, accessToken }));
          ...
          <RegisterCandidate setEditCandidate={setCandidate} id={idCan} />
        )}
        {/* Pendidikan */}{" "}
        {!editEducation ? (
...
export default GetCandidatePage;
